...
from cifpy.preprocess.format import (
...
def test_preprocess_cif_file_on_label_element_type_mixed():
    cif_dir = (
        "tests/data/cif/format_label/symbolic_atom_label_type_mixed"
    )
    ...
    for temp_cif_file_path in cif_file_path_list:
        ...
        if filename == "312084.cif":
            assert len(lines) == 3
            assert (
                lines[0].strip() == "Ge1A Ge 8 h 0 0.06 0.163 0.500"
            )
            assert (
                lines[1].strip() == "Pd1B Pd 8 h 0 0.06 0.163 0.500"
            )
        ...
        if filename == "1049941.cif":
            assert len(lines) == 11
            assert (
                lines[0].strip() == "Pr1 Pr 4 j 0.02076 0.5 0.30929 1"
            )
        ...
        if filename == "381111.cif":
            assert len(lines) == 6
            assert (
                lines[0].strip() == "Ni1A Ni 4 j 0 0.172 0.5 0.88(1)"
            )
            assert (
                lines[1].strip() == "Ga1B Ga 4 j 0 0.172 0.5 0.12(1)"
            )
        ...
        if filename == "1817279.cif":
            assert len(lines) == 3
            assert (
                lines[0].strip() == "Fe1 Fe 1 d 0.5 0.5 0.5 0.99(4)"
            )
            assert (
                lines[1].strip() == "Pt2 Pt 1 d 0.5 0.5 0.5 0.01(4)"
            )
        ...
        if filename == "1817275.cif":
            assert len(lines) == 4
            assert (
                lines[0].strip() == "Fe1 Fe 1 d 0.5 0.5 0.5 0.97(4)"
            )
            assert (
                lines[1].strip() == "Pt2 Pt 1 d 0.5 0.5 0.5 0.03(4)"
            )
        ...
        if filename == "1814810.cif":
            ...
            assert (
                lines[9].strip()
                == "Er13A Er 4 c 0.75 0.25 0.14542 0.83(2)"
            )
            assert (
                lines[10].strip()
                == "In13B In 4 c 0.75 0.25 0.14542 0.17(2)"
            )
            assert (
                lines[11].strip()
                == "In13A In 4 c 0.75 0.25 0.59339 0.93(3)"
            )
            assert (
                lines[12].strip()
        ...
        if filename == "1200981.cif":
            assert len(lines) == 4
            assert (
                lines[1].strip() == "SnB Sn 4 c 0.0595 0.25 0.0952 1"
            )
            assert (
                lines[2].strip() == "SnA Sn 4 c 0.0983 0.25 0.6419 1"
            )
